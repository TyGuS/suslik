...
PAPER_DIR = '/mnt/h/Work/papers/synsl/cyclic/final/tab' # Directory where to copy the latex file (if exists)
...
NEW_BENCHMARKS = [    
  ...
  BenchmarkGroup("Binary Tree", [
    ...
    Benchmark('tree/flatten-dll', 'flatten to dll in place', marks=['M']),
    ]),
