...
case class Environment(predicates: PredicateEnv,
                       ...
                       weightsOfAnyPhaseRules: ArrayBuffer[ArrayBuffer[Double]],
                       ordersOfPurePhaseRules: ArrayBuffer[ArrayBuffer[Int]],
                       weightsOfPurePhaseRules: ArrayBuffer[ArrayBuffer[Double]],
                       ordersOfSymbolicExecutionRules: ArrayBuffer[ArrayBuffer[Int]],
                       weightsOfSymbolicExecutionRules: ArrayBuffer[ArrayBuffer[Double]],
                       ordersOfUnfoldingPhaseRules: ArrayBuffer[ArrayBuffer[Int]],
                       weightsOfUnfoldingPhaseRules: ArrayBuffer[ArrayBuffer[Double]],
                       ordersOfAnyPhaseOrSpecBased: ArrayBuffer[ArrayBuffer[Int]],
                       ordersOfSketchHole: ArrayBuffer[ArrayBuffer[Int]],
                       weightsOfSketchHole: ArrayBuffer[ArrayBuffer[Double]],
                       ordersOfPointerPhaseRules: ArrayBuffer[ArrayBuffer[Int]],
                       weightsOfPointerPhaseRules: ArrayBuffer[ArrayBuffer[Double]],
                       ordersOfPostBlockPhaseRules: ArrayBuffer[ArrayBuffer[Int]],
                       weightsOfPostBlockPhaseRules: ArrayBuffer[ArrayBuffer[Double]],
                       ordersOfCallAbductionRules1: ArrayBuffer[ArrayBuffer[Int]],
                       weightsOfCallAbductionRules1: ArrayBuffer[ArrayBuffer[Double]],
                       ordersOfCallAbductionRules2: ArrayBuffer[ArrayBuffer[Int]],
                       weightsOfCallAbductionRules2: ArrayBuffer[ArrayBuffer[Double]],
                       ordersOfCallAbductionRules3: ArrayBuffer[ArrayBuffer[Int]],
                       weightsOfCallAbductionRules3: ArrayBuffer[ArrayBuffer[Double]],
                       ordersOfCallAbductionRules4: ArrayBuffer[ArrayBuffer[Int]],
                       weightsOfCallAbductionRules4: ArrayBuffer[ArrayBuffer[Double]],
                       ordersOfUnfoldingPostPhaseRules: ArrayBuffer[ArrayBuffer[Int]],
                       weightsOfUnfoldingPostPhaseRules: ArrayBuffer[ArrayBuffer[Double]],
                       ordersOfUnfoldingNoUnfoldPhaseRules: ArrayBuffer[ArrayBuffer[Int]],
                       weightsOfUnfoldingNoUnfoldPhaseRules: ArrayBuffer[ArrayBuffer[Double]],
                       ...
                       fewer_feature_combinations: Boolean
                      ) {
  def pp: String = {
